<template>
  <n-card title="简繁转换">
    ...
    />
    <n-card title="操作">
      <n-button type="primary" @click="jfHandleClick"> 简化繁 </n-button>
      <n-button type="info" @click="fjHandleClick"> 繁化简 </n-button>
    </n-card>
  </n-card>
</template>
      ...
      for (let i = 0; i < text.length; i++) {
        if (this.ftPYStr().indexOf(text.charAt(i)) != -1)
          str += this.charPYStr().charAt(
            this.ftPYStr().indexOf(text.charAt(i))
          );
        else if (this.qqPYStr().indexOf(text.charAt(i)) != -1)
          str += this.charPYStr().charAt(
            this.qqPYStr().indexOf(text.charAt(i))
          );
      ...
      for (let i = 0; i < text.length; i++) {
        if (this.charPYStr().indexOf(text.charAt(i)) != -1)
          str += this.ftPYStr().charAt(
            this.charPYStr().indexOf(text.charAt(i))
          );
        else if (this.qqPYStr().indexOf(text.charAt(i)) != -1)
          str += this.ftPYStr().charAt(this.qqPYStr().indexOf(text.charAt(i)));
        else str += text.charAt(i);
      }
      return str;
    },
